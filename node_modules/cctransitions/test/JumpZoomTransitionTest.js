var TransitionBase = cc.Layer.extend({
    init:function () {
        ...
        var title = cc.LabelTTF.create("JumpZoomTransition", "Thonburi", 32);
        this.addChild(title);
        ...
        this.scheduleOnce(this.step, 5.0);
        return true;
    },
    ...
    step:function (dt) {
        ...
        var aTransition = cc.TransitionJumpZoom.create(1.2, layer);
        if (aTransition)
...
var JumpZoomTransitionTest = TransitionBase.extend({
    backgroundImage:res.background1_png,
    sceneName:"Scene 1",
    createNextScene:function() {
        return new JumpZoomTransitionTest2();
    }
});

var JumpZoomTransitionTest2 = TransitionBase.extend({
    backgroundImage:res.background2_png,
    sceneName:"Scene 2",
    createNextScene:function() {
        return new JumpZoomTransitionTest();
    }
});

JumpZoomTransitionTest.create = function(args){
    var layer = new JumpZoomTransitionTest();
