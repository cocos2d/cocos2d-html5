...
cc.gameModules = [ jsRes.CCNodeTest2_js, jsRes.CCNodeTest6_js, jsRes.BoundingBoxTest_js,
    ...
    jsRes.SchedulerSchedulesAndRemoveTest_js,
...
resCfg[jsRes.SpriteNilTexture_js] = { layer : "SpriteNilTexture", title : "Sprite without texture", subTitle : "opacity and color should work" };
resCfg[jsRes.TextureColorCacheIssue_js] = { layer : "TextureColorCacheIssue", title : "Texture Color Cache Issue Test", subTitle : "You should see two different sprites colored green and blue" };
...
resCfg[jsRes.BoundingBoxTest_js] = { layer : "BoundingBoxTest", title : "Bounding Box Test", subTitle : "Testing getBoundingBox(). See console" };

resCfg[jsRes.SchedulerAutoremoveTest_js] = { layer : "SchedulerAutoremoveTest", title : "Self-remove an scheduler", subTitle : "1 scheduler will be auto Removed in 3 seconds. See console" };
resCfg[jsRes.SchedulerPauseResumeTest_js] = { layer : "SchedulerPauseResumeTest", title : "Pause / Resume", subTitle : "Scheduler should be paused after 3 seconds. See console" };
resCfg[jsRes.SchedulerUnscheduleAllTest_js] = { layer : "SchedulerUnscheduleAllTest", title : "Unschedule All callbacks", subTitle : "All scheduled callbacks will be unscheduled in 4 seconds. See console" };
resCfg[jsRes.SchedulerUnscheduleAllHardTest_js] = { layer : "SchedulerUnscheduleAllHardTest", title : "Unschedule All callbacks #2", subTitle : "Unschedules all callbacks after 4s. Uses CCScheduler. See console" };
resCfg[jsRes.SchedulerSchedulesAndRemoveTest_js] = { layer : "SchedulerSchedulesAndRemoveTest", title : "Schedule from Schedule", subTitle : "Will unschedule and schedule callbacks in 4s. See console" };
resCfg[jsRes.SchedulerUpdateTest_js] = { layer : "SchedulerUpdateTest", title : "Schedule update with priority", subTitle : "3 scheduled updates. Priority should work. Stops in 4s. See console" };
resCfg[jsRes.SchedulerUpdateAndCustomTest_js] = { layer : "SchedulerUpdateAndCustomTest", title : "Schedule Update + custom callback", subTitle : "Update + custom callback at the same time. Stops in 4s. See console" };
resCfg[jsRes.ScheduleUsingSchedulerTest_js] = { layer : "ScheduleUsingSchedulerTest", title : "Schedule / Unschedule using Scheduler", subTitle : "After 5 seconds all callbacks should be removed" };

resCfg[jsRes.LayerTest1_js] = { layer : "LayerTest1", title : "ColorLayer resize" };
resCfg[jsRes.IgnoreAnchorpointTest1_js] = { layer : "IgnoreAnchorpointTest1", title : "ignore Anchorpoint Test #1", subTitle : "red:true  green:true" };
