 ...
 */
var ProgressTimerRadial = cc.Layer.extend({
   init:function(){
       this._super();
       var winSize = cc.Director.getInstance().getWinSize();
       var to1 = cc.ProgressTo.create(5, 100);
       var to2 = cc.ProgressTo.create(5, 75);
       ...
       middle.setType(cc.PROGRESS_TIMER_TYPE_RADIAL);
...
ProgressTimerRadial.create = function(args){
    var layer = new ProgressTimerRadial();
