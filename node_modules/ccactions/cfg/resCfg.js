...
resCfg[jsRes.ActionManualTest_js] = {layer : "ActionManualTest", title : "Sprite properties - [Manual Transformation]"}
...
resCfg[jsRes.ActionJumpTest_js] = {layer : "ActionJumpTest", title : "cc.JumpTo / cc.JumpBy - [Actions will stop for 0.25s after 2 seconds]"}
resCfg[jsRes.ActionBezierTest_js] = {layer : "ActionBezierTest", title : "cc.BezierBy / cc.BezierTo"}
resCfg[jsRes.ActionBezierToCopyTest_js] = {layer : "ActionBezierToCopyTest", title : "cc.BezierTo copy test - [Both sprites should move across the same path]"}
resCfg[jsRes.Issue1008Test_js] = {layer : "Issue1008Test", title : "Issue 1008 - [cc.BezierTo + Repeat. See console]"}
...
resCfg[jsRes.ActionAnimateTest_js] = {layer : "ActionAnimateTest", title : "Animation - [Center: Manual animation. Border: using file format animation]"}
