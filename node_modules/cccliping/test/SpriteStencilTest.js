...
var SpriteStencilTest = cc.LayerGradient.extend({
    _clipper: null,
    _content: null,
    _stencil: null,
    ...
    ctor: function() {
        ...
        // Create sprite as stencil of clipping node
        this._stencil = cc.Sprite.create(res.grossini_png);
        this._stencil.setScale(1.5);
        ...
        // Create triangle as content of clipping node
        this._content = cc.DrawNode.create();
        var triangle = [cc.p(-width, -height),cc.p(width, -height), cc.p(0, height)];
        var green = cc.c4f(0, 1, 0, 1);
        this._content.drawPoly(triangle, green, 3, green);
...
SpriteStencilTest.create = function() {
    return new SpriteStencilTest();
}