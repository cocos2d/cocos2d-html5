...
var ParticleDemo = cc.LayerColor.extend({
    ...
    ctor:function(){
        ...
        var menu = cc.Menu.menuWithItems(item1, item2, item3);//, item4, null);
        ...
        //item4.setPosition( cc.PointMake( 0, 100) );
    ...
    restartCallback:function(pSender){this._m_emitter.resetSystem(); },
    ...
    registerWithTouchDispatcher:function(){cc.TouchDispatcher.sharedDispatcher().addTargetedDelegate(this, 0, false);},
    ccTouchBegan:function(touch,event){return true;},
    ccTouchMoved:function(touch,event){return this.ccTouchEnded(touch, event);},
...
var DemoFirework = ParticleDemo.extend({
    ...
    title:function(){return "ParticleFireworks";}
});
...
var DemoFire = ParticleDemo.extend({
    ...
    title:function(){return "ParticleFire";}
});
...
var DemoSun = ParticleDemo.extend({
    ...
    title:function(){return "ParticleSun";}
});
...
var DemoGalaxy = ParticleDemo.extend({
    ...
    title:function(){return "ParticleGalaxy";}
});
...
var DemoFlower = ParticleDemo.extend({
    ...
    title:function(){return "ParticleFlower";}
});
...
var DemoBigFlower = ParticleDemo.extend({
    ...
    title:function(){return "ParticleBigFlower";}
});
...
var DemoRotFlower = ParticleDemo.extend({
    ...
    title:function(){return "ParticleRotFlower";}
});
...
var DemoMeteor = ParticleDemo.extend({
    ...
    title:function(){return "ParticleMeteor";}
});
...
var DemoSpiral = ParticleDemo.extend({
    ...
    title:function(){return "ParticleSpiral";}
});
...
var DemoExplosion = ParticleDemo.extend({
    ...
    title:function(){return "ParticleExplosion";}
});
...
var DemoSmoke = ParticleDemo.extend({
    ...
    title:function(){return "ParticleSmoke";}
});
...
var DemoSnow = ParticleDemo.extend({
    ...
    title:function(){return "ParticleSnow";}
});
...
var DemoRain = ParticleDemo.extend({
    ...
    title:function(){return "ParticleRain";}
});
...
var DemoModernArt = ParticleDemo.extend({
    ...
    title:function(){return "Varying size";}
});
...
var DemoRing = ParticleDemo.extend({
    ...
    title:function(){return "Ring Demo";}
});
...
var ParallaxParticle = ParticleDemo.extend({
    ...
    title:function(){return "Parallax + Particles";}
});
...
var RadiusMode1 = ParticleDemo.extend({
    ...
    title:function(){return "Radius Mode: Spiral";}
});
...
var RadiusMode2 = ParticleDemo.extend({
    ...
    title:function(){return "Radius Mode: Semi Circle";}
});
...
var Issue704 = ParticleDemo.extend({
    ...
    title:function(){return "Issue 704. Free + Rot";},
    subtitle:function(){return "Emitted particles should not rotate";}
});
...
var Issue870 = ParticleDemo.extend({
    ...
    title:function(){return "Issue 870. SubRect";},
    subtitle:function(){return "Every 2 seconds the particle should change";},
